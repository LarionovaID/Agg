...
namespace geo_dotnet.Forms.Employee
{
	public partial class EmployeeMainForm : Form
	{
		...
		private void btn_Projects_Click_1(object sender, EventArgs e)
		{
			...
			string queryString = $"select P.Id, P.DateStart, P.DateEnd, P.Descriptoin, P.CustomerId, P.UserId_Worker from Projects as P LEFT JOIN CustomerCompanies AS CC ON P.CustomerId = CC.Id LEFT JOIN Users AS U ON CC.UserId = U.Id where U.Id = {wId};";
